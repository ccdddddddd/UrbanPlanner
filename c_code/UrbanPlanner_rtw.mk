...
## Generated on : Tue Jan 31 14:49:06 2023
...
START_DIR                 = C:/Wroks/CityPlanner/City20230130/codegen/lib/UrbanPlanner
TGT_FCN_LIB               = None
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IC:/Wroks/CITYPL~1/CID9CA~1 -I$(MATLAB_ROOT)/extern/include
...
%.obj : C:/Wroks/CityPlanner/City20230130/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
