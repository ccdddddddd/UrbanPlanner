...
int main()
{
 ...
 // memset(AvoMainRoVehInfo.targetLaneFrontDisAvoidVehicle,1000,sizeof(AvoMainRoVehInfo.targetLaneFrontDisAvoidVehicle));
  ...
  // 注意GlobVars是全局变量！
	...
	第1帧轨迹
	100.497	0.300527	89.8199	9.87246	0.0310351	0	0	
	第2帧轨迹
	100.987	0.303983	89.3248	9.75027	0.114899	-9.90075	0	
	第3帧轨迹
	101.472	0.312691	88.5773	9.63234	0.239228	-14.951	0	
	第4帧轨迹
	101.951	0.328402	87.6331	9.51749	0.39339	-18.8836	0	
	第5帧轨迹
	102.424	0.352373	86.5425	9.40469	0.568214	-21.8124	0	
	第44帧轨迹
	119.5	3.615	90	10	0	3.60228	0	
